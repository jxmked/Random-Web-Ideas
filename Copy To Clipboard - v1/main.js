...
var CopyToClipboard = /** @class */ (function () {
    function CopyToClipboard(element) {
        ...
        var clickEvent = function () {
            window.setTimeout(function () { return _this.element.addEventListener("click", clickEvent); }, _this.__interval);
    ...
    CopyToClipboard.prototype.__copyNavigator = function (str, s) {
        // @ts-expect-error
        window.navigator.clipboard.writeText(str).then(s)["catch"](function (e) { throw e; });
    };
    /**
